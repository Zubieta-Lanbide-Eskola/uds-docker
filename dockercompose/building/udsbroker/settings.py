...
# OpenUDS's taskManager expect naive timezones and newer versions of Django
#  use aware timezones by default
USE_TZ = False
...
if (
    any(
        arg.endswith("test") or "pytest/" in arg or "/pytest" in arg for arg in sys.argv
    )
...
try:
    with open("/app/rsa_key") as keyfile:
